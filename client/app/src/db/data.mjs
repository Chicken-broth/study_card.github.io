export default {
  ...
  },
  {
    ...
    question_text: "ITIL®では、サービスマネジメントをどのように定義していますか？",
    question_interaction: {
      type: "MultipleChoice",
      data: {
        texts: [
  ...
  },
  {
    ...
    question_text: "ITIL®の継続的サービス改善における「7ステップの改善プロセス」の最終ステップは何ですか？",
    question_interaction: {
      type: "MultipleChoice",
      data: {
        texts: [
  ...
  },
  {
    ...
    question_text: "パフォーマンス評価において、ITIL®で定義されているサービスマネジメントシステムの適切性、妥当性及び有効性を継続的に改善するための評価基準として用いられる指標はどれですか？",
    question_interaction: {
      type: "MultipleChoice",
      data: {
        texts: [
  ...
  },
  {
    ...
    question_text: "PMBOK®ガイド第6版によれば、プラスの影響を及ぼすリスク（好機）に対する「強化」の戦略はどれですか？",
    question_interaction: {
      type: "MultipleChoice",
      data: {
        texts: [
